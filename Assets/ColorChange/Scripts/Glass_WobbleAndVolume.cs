...
public class Glass_WobbleAndVolume : MonoBehaviour
{//// Public variables, accessible in the inspector
    ...
    private MonoBehaviour particleRootBehaviour;
    ...
    public void ParticleCollision() // Custom method - called from GlassCollider script on GlassParticleCollider
    {
        ...
        if (otherID != lastID)
        {
            ...
            {
                // Awful sin
                particleRootBehaviour = (MonoBehaviour)particleTransform.parent.parent.parent.parent.parent.gameObject.GetComponent(typeof(MonoBehaviour));
            }
            else if (other.name == "ContainerColliderOnlyParticles_Spout")
            {
                particleRootBehaviour = (MonoBehaviour)particleTransform.parent.parent.gameObject.GetComponent(typeof(MonoBehaviour));
            }
            lastID = otherID;
        ...
        if (particleRootBehaviour != null)
        {
            ...
            */
            int positionOfLastValue = position;
